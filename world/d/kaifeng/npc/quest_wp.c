...
mapping quests_weapon = ([
     ...
     100 : ({ "find", "铁锤",         "hammer",             "", "1" }),
     150 : ({ "find", "桂树枝",       "guishuzhi",          "", "1" }),
     200 : ({ "find", "镔铁棍",       "bintiegun",          "", "1" }),
     220 : ({ "find", "齐眉棍",       "qimeigun",           "", "1" }),
     240 : ({ "find", "竹扫帚",       "broom",              "", "1" }),
     260 : ({ "find", "木棒",         "mu bang",            "", "1" }),
     280 : ({ "find", "木叉",         "fork",               "", "1" }),
     300 : ({ "find", "风回雪舞剑",   "snowsword",          "", "1" }),

     400 : ({ "find", "九股托天叉",   "tuotian fork",       "", "1" }),
     500 : ({ "find", "八瓣梅花锤",   "meihua hammer",      "", "1" }),
     600 : ({ "find", "铁斧",         "lumber axe",         "", "1" }),
  ...
  320000 : ({ "find", HIC "点钢枪" NOR, "steel spear",     "", "1" }),

  400000 : ({ "find", "绣花针",       "xiuhua zhen",        "", "1" }),
  420000 : ({ "find", "碧玉双枪",     "jade spear",         "", "1" }),
  440000 : ({ "find", "青锋剑",       "qingfeng sword",     "", "1" }),
  460000 : ({ "find", "无常棒",       "wuchang bang",       "", "1" }),
 ...
 1500000 : ({ "find", "紫金红葫芦",   "hu lu",              "", "1" }),
 1600000 : ({ "find", "羊脂玉净瓶",   "jing ping",          "", "1" }),
