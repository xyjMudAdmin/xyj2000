...
int ask_me()
{
	...
	command("say 这你还用问我？！");
	return 1;
//	return "这你还用问我？！";	// if already in wudidong, nopoint
    }
...
//	return "嘿嘿，你若是不愿，可莫怪我心狠手辣！";
	...
	command("say 否则就别怪我杀人灭口了！");
    call_out("mie_kou", 60, me);		// will not transform back into
	return 1;
//    return "否则就别怪我杀人灭口了！";		// human coz heneeds to kill
}
void transform()
{
  object weapon;
...
//    if (!interactive()) return;
	...
	command("say 不错，识时务者为俊杰！");	// don't kill him, compliment him
